...
import com.example.myapplicationtranslator.adapter.NotebookMarkItemAdapter;
...
public class NotebookFragment extends Fragment{
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
                ...
                dialog.setButton(DialogInterface.BUTTON_POSITIVE, getString(R.string.OK), new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        if (in.isEmpty() || out.isEmpty()) {
                            ...
                            if (tvNotebook.getVisibility() == View.VISIBLE) {
                                tvNotebook.setVisibility(View.GONE);
                            }
        ...
        getDataFromDB();
        if(list.isEmpty()){
            tvNotebook.setVisibility(View.VISIBLE);
        }
            ...
            public void OnSubViewClick(View view, final int position) {
                switch (view.getId()){
                    ...
                    case R.id.image_view_mark_star:
                        ...
                        Snackbar.make(fab,R.string.remove_from_notebook,Snackbar.LENGTH_SHORT).setAction(R.string.remove_from_notebook,new View.OnClickListener(){
                            @Override
    ...
    private void initViews(View view){
        ...
        tvNotebook = (TextView) view.findViewById(R.id.tv_no_note);
    }
