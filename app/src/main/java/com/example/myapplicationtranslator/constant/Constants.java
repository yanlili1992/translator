package com.example.myapplicationtranslator.constant;
...
public class Constants {
    ...
    //有道词典base url
    public static final String YOUDAO_URL = "http://fanyi.youdao.com/openapi.do?keyfrom=example.myapplicationtranslator";
